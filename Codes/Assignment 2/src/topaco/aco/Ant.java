...
public class Ant {
    ...
    public void constructRoute(double[][] pheromones, double alpha, double beta) {
        ...
        while (true) {
            int next = selectNextNode(current, pheromones, alpha, beta);
            if (next == -1) break;
    ...
    private int selectNextNode(int current, double[][] pheromones, double alpha, double beta) {
